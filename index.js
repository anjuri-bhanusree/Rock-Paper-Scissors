    ...
    const computerColour = buttonOptions[choice];
        switch(computerColour){
            case "red": setTimeout(function(){
                        ...
                        document.querySelector(".comp button img").src="./images/icon-rock.svg";},300);
            ...
            case "yellow":setTimeout(function(){
                        ...
                        document.querySelector(".comp button img").src="./images/icon-scissors.svg";},300);
            ...
            case "blue":setTimeout(function(){
                        ...
                        document.querySelector(".comp button img").src="./images/icon-paper.svg";},300);
